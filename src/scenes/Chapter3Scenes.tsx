...
export const Scene3_14_NextHook: React.FC = () => (
  <div className="flex flex-col items-center justify-center h-full px-8 text-center max-w-3xl mx-auto relative">
    ...
    >
      ...
      <span className="text-xs font-mono uppercase tracking-widest text-rose-500 font-extrabold">Up Next · Chapter 4</span>

      <h1 className="text-4xl md:text-5xl font-black tracking-tight text-slate-800 leading-tight">
        You can measure space.<br />
        <span className="text-rose-500">Now let's reshape it.</span>
      </h1>

      <div className="w-16 h-1.5 bg-gradient-to-r from-rose-400 to-amber-500 rounded-full" />
      ...
      >
        Dot products let you measure alignment. But matrices let you <em>transform</em> entire spaces — rotate, stretch, shear, and collapse them. This is how every layer of a neural network works.
      </motion.p>
      ...
      >
        {[['Rotations', '#E11D48'], ['Matrix Multiply', '#D97706'], ['Neural Layers', '#7C3AED']].map(([label, color]) => (
